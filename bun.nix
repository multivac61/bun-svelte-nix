# Set of Bun packages to install
{
  ...
  "@sveltejs/adapter-auto" = {
    ...
    name = "@sveltejs/adapter-auto@7.0.0";
  ...
  "vite" = {
    ...
    hash = "sha512-ZWyE8YXEXqJrrSLvYgrRP7p62OziLW7xI5HYGWFzOvupfAlrLvURSzv/FyGyy0eidogEM3ujU+kUG1zuHgb6Ug==";
  };
  "vitefu" = {
    out_path = "vitefu";
    name = "vitefu@1.1.1";
